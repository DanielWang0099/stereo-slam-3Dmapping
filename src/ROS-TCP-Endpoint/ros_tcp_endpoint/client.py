        ...
        try:
            while not halt_event.is_set():
                ...
                if self.tcp_server.pending_srv_id is not None:
                    ...
                    # Handle gate navigation commands
                    if destination == "__start_gate_navigation":
                        self.tcp_server.syscommands.start_gate_navigation()
                    elif destination == "__stop_gate_navigation":
                        self.tcp_server.syscommands.stop_gate_navigation()
                    elif destination == "__get_gate_navigation_status":
                        self.tcp_server.syscommands.get_gate_navigation_status()
                    else:
                        # handle other system commands, such as registering new topics
